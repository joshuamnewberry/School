...
public class SampleSigned16BitAdderTest {
  ...
  public static final long testIntegers[] = { -32768, -32767, -20000, -10000, -5000, -2500, 0, 1, 2, 13, 127, 128, 129, 1000, 1500, 10000, 20000, 25000, 0x5555, 32766, 32767 };
  ...
  protected static void verify(long a, long b, boolean carryIn) {
    ...
    System.out.println("Output: " + readPinSigned("Output"));
    System.out.println("Overflow: " + readPinSigned("Overflow"));
    System.out.println("CarryOut: " + readPinSigned("CarryOut") + "\n\n");
