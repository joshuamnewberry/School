...
public class SampleUnsigned16BitAdderTest {
  ...
  public void zero_zero_false() {
    ...
    run();
    System.out.println("zero_zero_false: " + readPinUnsigned("Output"));
  ...
  public void zero_one_false() {
    ...
    setPin("CarryIn", false);
    run();
    System.out.println("zero_one_false: " + readPinUnsigned("Output"));
  ...
  public void zero_zero_true() {
    ...
    setPin("CarryIn", true);
    run();
    System.out.println("zero_zero_true: " + readPinUnsigned("Output"));
    Assert.assertEquals(1, readPinUnsigned("Output"));
    Assert.assertFalse(readPin("CarryOut"));
  }
  ...
  public void zero_one_true() {
    ...
    setPin("CarryIn", true);
    run();
    System.out.println("zero_one_true: " + readPinUnsigned("Output"));
